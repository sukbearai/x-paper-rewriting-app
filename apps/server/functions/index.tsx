...
import { ai, alipay, otp, points, rewrite, sms, user } from './routers/index'

const app = new Hono().basePath('/')

app.use('*', cors({
  origin: ['https://www.ttdjai.com', 'https://paper.congrongtech.cn', 'http://localhost:5173', 'http://localhost:8080'], // 回显请求头里的 Origin；空值时回退
...
app.route('/alipay', alipay)
app.route('/rewrite', rewrite)
